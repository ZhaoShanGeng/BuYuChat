<script lang="ts">
  ...
  import AgentSettingsPanel from "../agents/AgentSettingsPanel.svelte";
  import AgentSidebarPanel from "../agents/AgentSidebarPanel.svelte";
  import ChatPanel from "../chat/ChatPanel.svelte";
  import ConversationSidebarPanel from "../conversations/ConversationSidebarPanel.svelte";
  import IconRail from "./IconRail.svelte";
  import SettingsChannelSidebar from "../settings/SettingsChannelSidebar.svelte";
  import SettingsPage from "../settings/SettingsPage.svelte";
  import { createSettingsPageState } from "../settings/settings-page-state.svelte.js";
